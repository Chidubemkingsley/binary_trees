...
<str>Read or watch:</str>
   ...
   <i> Binary tree (note the first line: Not to be confused with B-tree.)
    Data Structure and Algorithms - Tree
    Tree Traversal
    Binary Search Tree
    Data structures: Binary Tree</i>
...
General</br>
   ...
   <i> What is a binary tree
    ...
    What is a complete, a full, a perfect, a balanced binary tree</i>

##AUTHORS: GROUP PROJECT BY RUBELUCHUKWUISI CHIDUBEM KINGSLEY
